  ...
  return ( 
    <section> 
      ...
      <form onSubmit={handleSubmit}> 
        ...
        <input name="age" type="number" min="0" placeholder="Age" value={form.age} onChange={handleChange} required /> 
        <input name="call_sign" placeholder="Call sign" value={form.call_sign} onChange={handleChange} /> 
